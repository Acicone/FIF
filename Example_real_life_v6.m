...
L=2*length(x);
x_ext = Extend_sig_v2(x,{'asymw'},L,true);

%%
opts=Settings_FIF_v3('delta',10^-2,'Xi',3,'NIMFs',4,'alpha',20);
clc
tic
[IMF_1,logM1] = FIF_v2_12(x,opts);%y,opts);
toc
tic
[IMF_2,logM2] = FIF_v2_12(x_ext,opts);%y,opts);
toc
%

function options = Settings_FIF_v4(varargin)
% 
% Settings_FIF_v4 Constructs option structure for the algorithms
%
% EXAMPLES
%
% OPTIONS = Settings_FIF_v4 with no input arguments returns
%   setting structure with default values
%
% OPTIONS = Settings_FIF_v4('NAME1',VALUE1,'NAME2',VALUE2,...) creates a
%   solution options structure OPTIONS in which the named properties have
%   the specified values.  Any unspecified properties have default values.
%   It is sufficient to type only the leading characters that uniquely
%   identify the property.  Case is ignored for property names.
%
% OPTIONS = Settings_FIF_v4(OLDOPTIONS,'NAME1',VALUE1,...) alters an existing options
%   structure OLDOPTIONS.
%
%
% Settings_FIF_v4 PROPERTIES :
%
% GENERAL
% 
...
%  Derivative   (0)    Derivative number of the signal to be used for the
...
% EXAMPLE
%          
%   >> options = Settings_FIF_v4('delta',0.08,'NIMFs',5,'plots',1) 
%   >> IMF = FIF_v2_14(x,options)
%              
%  Executes algorithm FIF_v2_14 with delta = 0.08, stops after we have at most 5 IMFs and a trend, it produces plots.                            
% ------------------------------------------------------      
%
